...
inline const std::string Dice_Ver = Dice_Ver_Without_Build + ".Oliva.1.1.0(" + std::to_string(Dice_Build) + ")";
inline const std::string Dice_Short_Ver = "Dice! by 溯洄 Shiki 仑质 Ver " + Dice_Ver;
